---
title: "ASSIGNMENT_5_MDTS4214_0733"
...
###### 𝐻0:𝜇(Premium)=𝜇(Ideal)
###### against
###### 𝐻1:𝜇(Premium)≠𝜇(Ideal)
###### From the output, we have:
###### 𝑝<2×10^(−16)
###### Since,𝑝<0.05,reject 𝐻0.
###### The expected price of a Premium cut diamond is significantly different from that of an Ideal cut diamond. Also, 𝜇^ (Ideal)−𝜇^(Premium)= −1126.72, it implies:
###### 𝜇 ^(Premium) −𝜇^(Ideal)= 1126.72
